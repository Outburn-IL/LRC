...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ILCoreDiagnosticReport
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      <sch:assert test="count(f:extension[@url = 'http://fhir.health.gov.il/StructureDefinition/ext-diagnostic-report-note']) &lt;= 1">extension with URL = 'http://fhir.health.gov.il/StructureDefinition/ext-diagnostic-report-note': maximum cardinality of 'extension' is 1</sch:assert>
